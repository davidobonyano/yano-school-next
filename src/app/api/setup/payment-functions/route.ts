...
export async function POST(request: Request) {
  try {
    ...
    // SQL for creating the payment management functions
    ...
    const { error } = await supabase.rpc('execute_sql', { sql: createFunctionsSQL });
    ...
    return NextResponse.json({ 
      success: true,
      message: 'Payment management functions created successfully'
    });
